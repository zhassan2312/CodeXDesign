...
const Project = () => {
  return (
    <div className='relative w-full bg-[#CDEA68] flex-col items-center flex justify-center gap-[2vw] lg:gap-[3vw] lg:py-[4vw] py-16'>
        ...
        <Button className={'pl-8 pr-16 lg:pl-[2vw] lg:pr-[4vw] py-[1vw] '} text={'Start Project'} isWhite={false} />
        <h1 className='text-[3vw] leading-none text-zinc-900 tracking-tighter font-poppins font-extralight uppercase'>OR</h1>
        <OutlineButton className={'pl-8 pr-16 lg:pl-[2vw] lg:pr-[4vw] py-[1vw]'} text={'zhassan2312@gmail.com'} />
    </div>
  )
}
